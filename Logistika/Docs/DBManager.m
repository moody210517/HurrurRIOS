...
-(WNACountry*)getCountryFromName:(NSString *)param{
    ...
    if (country == nil) {
        country = [self getCountryFromLocalName:param];
    }
    
    
    return country;
}
-(WNACountry*)getCountryFromLocalName:(NSString *)param{
    WNACountry* country = nil;
    NSString* query;
    query = [NSString stringWithFormat:@"select * from countries where localName like  '%%%@%%'",param];
