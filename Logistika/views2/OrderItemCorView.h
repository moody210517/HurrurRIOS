...
@interface OrderItemCorView : OrderBaseView<UITableViewDelegate,UITableViewDataSource>
...
@property (weak, nonatomic) IBOutlet BorderLabel *lblFrieght;
@property (weak, nonatomic) IBOutlet BorderLabel *lblLoadType;
@property (weak, nonatomic) IBOutlet BorderLabel *lblScanCon;
@property (weak, nonatomic) IBOutlet BorderLabel *lblDateTime;
@property (weak, nonatomic) IBOutlet BorderLabel *lblVehicleNumber;
@property (weak, nonatomic) IBOutlet BorderLabel *lblDriverID;
@property (weak, nonatomic) IBOutlet BorderLabel *lblDriverName;
